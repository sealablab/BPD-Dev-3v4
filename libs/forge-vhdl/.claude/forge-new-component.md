...
**Version:** 1.0
**Purpose:** Component requirements elicitation and file structure scaffolding for forge-vhdl
...
5. **Special Requirements:**
   - FORGE-aware (uses ready_for_updates)?
...
```
vhdl/utilities/forge_util_pwm.vhd                     # VHDL entity
cocotb_test/forge_util_pwm_tests/                     # Test directory
...
cocotb_test/test_forge_util_pwm_progressive.py        # Orchestrator
```

**For a package (e.g., timing utilities):**
```
vhdl/packages/forge_timing_pkg.vhd                    # Package
cocotb_test/forge_timing_pkg_tb_wrapper.vhd           # Test wrapper (needed!)
cocotb_test/forge_timing_pkg_tests/                   # Test directory
├── forge_timing_pkg_constants.py
├── P1_forge_timing_pkg_basic.py
└── __init__.py
cocotb_test/test_forge_timing_pkg_progressive.py      # Orchestrator
```

**For FORGE-aware component:**
```
vhdl/utilities/forge_util_counter_main.vhd            # Layer 3 (main logic)
vhdl/utilities/forge_util_counter_shim.vhd (optional) # Layer 2 (if standalone)
cocotb_test/forge_util_counter_tests/                # Tests
├── forge_util_counter_constants.py
├── P1_forge_util_counter_basic.py
└── __init__.py
cocotb_test/test_forge_util_counter_progressive.py    # Orchestrator
```

**Update test_configs.py:**
```
cocotb_test/test_configs.py  # Add TestConfig entry
```
...
**Example:** `vhdl/utilities/forge_util_pwm.vhd.md`
...
**Example:** `cocotb_test/forge_util_pwm_tests/P1_forge_util_pwm_basic.py.md`
...
**Example:** `cocotb_test/forge_util_pwm_tests/forge_util_pwm_constants.py.md`
...
- HDL_SOURCES = [Path("../vhdl/utilities/forge_util_pwm.vhd")]
...
- `vhdl/utilities/forge_util_pwm.vhd.md`

**Test Design (Agent: cocotb-progressive-test-designer):**
- `cocotb_test/forge_util_pwm_tests/forge_util_pwm_constants.py.md`

**Test Implementation (Agent: cocotb-progressive-test-runner):**
- `cocotb_test/forge_util_pwm_tests/__init__.py` (created)
- `cocotb_test/forge_util_pwm_tests/P1_forge_util_pwm_basic.py.md`
- `cocotb_test/test_forge_util_pwm_progressive.py.md`

**Configuration Update:**
- `cocotb_test/test_configs.py` (entry placeholder added)
...
**Name:** <component_name>
**Category:** <utilities|packages|debugging|loaders>
...
**Structure:**
```
vhdl/utilities/<component>.vhd.md
cocotb_test/<component>_tests/
  ├── <component>_constants.py.md
  ├── P1_<component>_basic.py.md
  └── __init__.py (create empty)
cocotb_test/test_<component>_progressive.py.md
```
...
cocotb_test/<pkg_name>_tb_wrapper.vhd.md  # WRAPPER NEEDED!
cocotb_test/<pkg_name>_tests/
  ├── <pkg_name>_constants.py.md
  ├── P1_<pkg_name>_basic.py.md
  └── __init__.py
cocotb_test/test_<pkg_name>_progressive.py.md
```
...
### Pattern 3: FORGE-Aware Component

**Structure:**
```
vhdl/utilities/<component>_main.vhd.md      # Layer 3 (main logic)
vhdl/utilities/<component>_shim.vhd.md      # Layer 2 (optional)
cocotb_test/<component>_tests/
  ├── <component>_constants.py.md
  ├── P1_<component>_basic.py.md
  └── __init__.py
...
**FORGE Requirements:**
- Uses ready_for_updates handshaking
- Imports forge_common_pkg
- May have separate main + shim entities

**Examples:** forge_counter (from today's session)
